    ...
    entries.forEach(entry => {
      ...
      if (entry.changes) {
        entry.changes.forEach(change => {
          ...
          if (changeType === 'Added') { const name = escapeHtml(change.server_name || change.server_id), iconPath = escapeHtml('gfx/login_icon_' + encodeURIComponent(rawServerId) + '.png'), imgTag = '<img src="' + iconPath + '" style="width: 40px; height: 40px; vertical-align: middle; margin-right: 5px;" onerror="this.onerror=null;this.src=\'gfx/login_icon_developer4.png\'">'; addedArray.push('<a href="#' + serverIdUrl + '" style="color: #40ff40;">' + imgTag + '</a><a href="#' + serverIdUrl + '" style="color: #40ff40;">' + name + '</a>'); }
